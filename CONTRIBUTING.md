# Contributing to DotNet.GitlabCodeQualityBuildLogger
...
In short, when you submit code changes, your submissions are understood to be under the same [MIT License](https://github.com/timo-reymann/DotNet.GitlabCodeQualityBuildLogger/blob/main/LICENSE) that covers the project. Feel free to contact the maintainers if that's a concern.
